        ...
        <div class="row margin1050">
            <table class="table">
                ...
                <tr style="background: #ffffcc">
                    ...
                    style="border-bottom: 3px solid black;">
                        <img src="img/sd.png" class="img-fluid"><br>
                        <img src="img/sd.png" class="img-fluid"><br>
                        <img src="img/sd.png" class="img-fluid"><br>
                        <img src="img/bb.jpg" class="img-fluid"><br>
                    </td></tr>
                <tr><td class="text-left">이미지1</td><td>abcxyz.jpg (123KB, 99회 다운로드 함)</td></tr>
                <tr><td class="text-left">이미지2</td><td>123987.png (1.3MB, 1회 다운로드 함)</td></tr>
            </table>
        </div><!-- 본문 -->
