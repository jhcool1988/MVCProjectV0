...
import jhcool1988.service.MemberService;
...
public class JoinmeHandler implements ActionHandler {
    ...
    // 클라이언트의 요청이 /join/joinme.do라면
    // /WEB-INF/jsp 아래의 join/joinme.jsp를 출력함
    @Override
    public String execute(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (req.getMethod().equalsIgnoreCase("post")) {
            ...
            MemberVO m = new MemberVO(null,
                    name,jumin,userid,passwd,zipcode,addr1,addr2,email,mobile,null);
