    ...
    <div id="main">
        ...
        <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <button type="button" class="btn btn-success" disabled>실명인증</button>
                </li>
        ...
        <div class="margin30">
            ...
            <small class="text-muted">
               회원정보는 개인정보 취급방침에 따라 안전하게 보호되며, 회원님의 명백한 동의없이
                공개 또는 제3자에게 제공되지 않습니다.
            </small>
            <hr>
        </div><!--중간타이틀-->
                ...
                <div class="col-11">
                    ...
                    <div class="form-group row">
                        ...
                        <span class="col-form-label col-7 text-danger">
                            6~16자의 영문 소문자, 숫자와 특수기호만 사용할 수 있습니다.</span>
                    </div><!-- 아이디 -->
                    <div class="form-group row">
                        <label class="col-2 col-form-label"
                               for="pwd">비밀번호</label>
                    ...
                    <div class="form-group row">
                        ...
                        <span class="col-7">
                            ...
                            data-toggle="modal" data-target="#zipcode">
                                <i class="fa fa-question-circle"></i> 우편번호 찾기</button>
                        </span>
                    </div><!-- 우편번호 -->
                    <div class="form-group row">
                        <label class="col-2 col-form-label"
                    ...
                    <div class="form-group row">
                        ...
                        <button type="button" class="btn btn-dark">
                            <i class="fa fa-refresh"></i> 다른 captcha 보기</button>
                    </div><!-- 자동가입방지 -->
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        <div class="col-1"></div>
                        <div class="col-3">
                            <label for="dong" class="text-right
                            text-danger pushup"
